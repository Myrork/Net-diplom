...
В  результате выполнения дипломной работы были написаны конфигурационный файлы с развертывание нескольких виртуальный машин, на которых были установлены, с помощью ansible-playbook, zabbix, zabbix-agent, elasticsearsh, kibana, filebeat, и nginx, а так же было налажено их взаимодействие.
